...
window.addEventListener('DOMContentLoaded', function () {
    ...
    function customFile() {
        ...
        const xfCssOne = 'xfplayIcon.min.css'
        const xfCssTow = 'xf-MusicPlayer.min.css'
    ...
    function startExecutionPlayer() {
        ...
        let musicStr = `<div class="xf-MusicPlayer-Main">
    ...
    <div class="xf-outsideSongList">
        ...
        function allPlayerFeatures() {
            ...
            const getEle = dom => MusicPlayer.querySelector(dom)
                ...
                , musicPhoto = getEle('.xf-musicPhoto')
            ...
            const removebePlaying = () => {
                ...
                musicPhoto.classList.add('xf-pauseRotation')
            ...
            const addPlaying = () => {
                ...
                musicPhoto.classList.remove('xf-pauseRotation')
            ...
            const playerMusicItem = (index, music, picture, Title, Author, loadingTime) => {
                let lis = `<li class="xf-songsItem"data-index="${index}"data-mp3url="${music}"><div class="xf-songListSongPictures"><i class="xf-songIcon xficon icon-bofang"></i><img data-musicLjz-src="${picture + '?param=200x200'}"src="https://player.xfyun.club/img/playerLoad.gif"alt="songPicture"class="xf-playlistImg"></div><div class="xf-playlistSongInformation"><div class="xf-songTitle"><h5 class="xf-songName">${Title}</h5><p class="xf-authorAndDuration"><sapn class="xf-songAuthor">${Author}</sapn><span class="xf-songLength xficon icon-shijian">\t${loadingTime}</span></p></div></div></li>`
                    ...
                    try {
                        ...
                        checkSongsItemLength().then(async waitTime => {
                            ...
                            const updateSong = index => {
                                ...
                                musicPhoto.src = itemPic
                                musicPhoto.alt = itemName
                            ...
                            const currentMusic = () => {
                                if ( musicPicture.src === ""  || musicPhoto.src === "" || songName.textContent === "") {
                                    nextMusic()
                                    pauseMusic()
                                    removebePlaying()
